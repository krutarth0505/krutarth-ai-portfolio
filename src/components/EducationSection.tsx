      ...
      <div className="relative z-10">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {education.map((edu, index) => (
            <ScrollReveal key={edu.degree + edu.institution} direction="up" delay={index * 150}>
              <div className="glass-card p-6 md:p-8 rounded-xl animated-border hover:scale-[1.01] transition-transform duration-300">
